    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Add product to Rental cart</h4>
            </div>
            <div class="modal-body row">
                ...
                <div class="col-xs-12 col-sm-6">
                    ...
                    <div class="list-group">
                        ...
                        <span class="list-group-item"> <small>days:</small> <input type="number" class="count"
                                                                                    value="1" min="1" max="31"></span>
                        <div class="form-group">
                            <label for="date">from</label>
                            <input type="date" class="form-control" name="date" id="date_start">
                        </div>
            ...
            <div class="modal-footer">
                <button id="addToCart" type="button" class="btn btn-primary">Add to Rent</button>
