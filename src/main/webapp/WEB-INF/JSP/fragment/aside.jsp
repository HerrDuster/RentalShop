		...
		<div id="searchOptions" class="collapse">
			...
			<div class="panel-body categories">
				...
				<div class="form-group">
					<div class="checkbox">
						<label><input type="checkbox" name="category" value="1" class="search-option">GNSS</label>
					</div>
				</div>
				<div class="form-group">
					<div class="checkbox">
						<label><input type="checkbox" name="category" value="2" class="search-option">Total station</label>
					</div>
				</div>
			</div>
			...
			<div class="panel-body producers">
				...
				<div class="form-group">
					<div class="checkbox">
						<label><input type="checkbox" name="producer" value="1" class="search-option">Leica Geosystems</label>
					</div>
				</div>
				<div class="form-group">
					<div class="checkbox">
						<label><input type="checkbox" name="producer" value="2" class="search-option">Leica Geosystems </label>
					</div>
				</div>
			</div>
		</div>
...
<div id="productCatalog" class="panel panel-success collapse">
	...
	<div class="list-group">
		<c:forEach var="category" items="${CATEGORY_LIST}">
			<a href="/products${category.url}" class="list-group-item ${selectCategoryUrl == category.url ? 'active' : ''}">
